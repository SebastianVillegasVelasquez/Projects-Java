...
public class JwtService {
    ...
    private final static String SECURITY_KEY = "rIxvZveq7vx5v+g+fEwQFFstxgGT1F5tKB7yElewg65AMatX5ctZqy9nkBFo8DOz";
    ...
    private Key getSignIngKey() {
        byte[] signKey = Decoders.BASE64.decode(SECURITY_KEY);
